    ...
    <div className="relative inline-block text-left w-full sm:w-auto">
      <div>
        ...
        >
          <span className="mr-2">
            {status
              ? statusOptions.find((option) => option.value === status)?.label || "Analisar"
              : "Analisar"}
          </span>
      ...
      {isOpen && (
        <div
          className="origin-top-right absolute left-0 sm:right-0 mt-2 w-48 rounded-md shadow-lg bg-white ring-1 ring-black ring-opacity-5 z-10"
        >
